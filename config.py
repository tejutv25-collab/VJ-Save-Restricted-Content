...
# Bot token @Botfather
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8595592713:AAHbpcmMZ1xLCErgNPgdFbB0iK5tRmijlgA")
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://tejutv25_db_user:kTIxnohmIY2hLLKQ@cluster0.yaqyzwb.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
DB_NAME = os.environ.get("DB_NAME", "tejutv25_db_user")
